...
class VeelogApp extends ConsumerWidget {
  const VeelogApp({super.key});
...
final appInitializationProvider = FutureProvider<void>((ref) async {
  ...
  await ref.read(
    initializationProvider(
      StorageConfiguration(
        databasePath: path.join(dir.path, 'veelog.db'),
        relayGroups: {
          'default': {
            'wss://relay.damus.io',
  ...
  try {
    ...
    await signer.attemptAutoSignIn();
  } catch (e) {
